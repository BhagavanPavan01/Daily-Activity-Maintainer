...
function AnalyticsView({ activities }) {
    ...
    return (
        <div className="flex flex-col gap-6 sm:gap-8 w-full animate-fade-in mt-2 sm:mt-4">
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-2 sm:mb-4">Dynamic Analytics Dashboard</h2>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                <div className="bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/50 p-4 sm:p-6 rounded-2xl shadow-xl flex flex-col items-center justify-center gap-2 sm:gap-3 text-center relative overflow-hidden group">
                    ...
                    <FaChartBar className="text-3xl sm:text-4xl text-purple-400 mb-1 sm:mb-2 transform group-hover:scale-110 transition-transform" />
                    <span className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white">{stats.completionRate}%</span>
                    <span className="text-xs sm:text-sm text-slate-400 dark:text-slate-500 dark:text-slate-400 font-medium">Global Completion Rate</span>
                </div>

                <div className="bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/50 p-4 sm:p-6 rounded-2xl shadow-xl flex flex-col items-center justify-center gap-2 sm:gap-3 text-center relative overflow-hidden group">
                    <div className="absolute inset-0 bg-orange-500/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    <FaCalendarDay className="text-3xl sm:text-4xl text-orange-400 mb-1 sm:mb-2 transform group-hover:scale-110 transition-transform" />
                    <span className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white">{stats.totalDays}</span>
                    <span className="text-xs sm:text-sm text-slate-400 dark:text-slate-500 dark:text-slate-400 font-medium">Total Active Days</span>
                </div>
            </div>
                ...
                <div className="lg:col-span-1 flex flex-col gap-6">
                    <div className="bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/50 p-6 rounded-2xl shadow-xl flex flex-col relative overflow-hidden group">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">Current Streak</h3>
                                <p className="text-xs sm:text-sm text-slate-400 dark:text-slate-500 dark:text-slate-400">Consecutive days active</p>
                            </div>
                        </div>
                        <div className="flex items-end gap-2">
                            <span className="text-5xl sm:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500">{stats.currentStreak}</span>
                            <span className="text-lg sm:text-xl text-slate-300 dark:text-slate-600 dark:text-slate-300 mb-1 leading-none font-semibold">Days</span>
                        </div>
                    ...
                    <div className="bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/50 p-6 rounded-2xl shadow-xl flex flex-col relative overflow-hidden group">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">Most Productive Day</h3>
                                <p className="text-xs sm:text-sm text-slate-400 dark:text-slate-500 dark:text-slate-400">Day with highest accuracy</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 text-slate-900 dark:text-white h-full mt-2">
                            <span className="text-3xl sm:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400">{stats.bestDay}</span>
                        </div>
                    </div>
                </div>

                {/* CSS Based Interactive Bar Chart: Last 7 Days Activity */}
                <div className="lg:col-span-2 bg-slate-100/ dark:bg-slate-800/60 border border-slate-200/ dark:border-slate-700/50 p-4 sm:p-6 rounded-2xl shadow-xl flex flex-col relative overflow-hidden">
                    <h3 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white mb-6 flex items-center gap-3">
